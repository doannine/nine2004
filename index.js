$('.start').click(function(){
  $('.stage1').fadeOut();
  fire_modal('https://s3-us-west-2.amazonaws.com/s.cdpn.io/217233/cake_modal.png','Hãy làm một chiếc bánh nhé!','Vì hôm nay là sinh nhật của Ánh Ly nên tui thấy thật phù hợp khi Ánh Ly có thể tự làm chiếc bánh sinh nhật kỹ thuật số của mình. Bắt đầu bằng cách làm hỗn hợp bánh của bé, sau đó nướng trong lò kỹ thuật số và cuối cùng là trang trí. Chúc Ánh Ly sinh nhật vui vẻ và hạnh phúc');
})
...
$('.mixer').click(function(){
  ...
  if(mixtimes == 1){
      $('.stage2').fadeOut();
      fire_modal('https://s3-us-west-2.amazonaws.com/s.cdpn.io/217233/mix_modal.png','Trộn thành công!','Xin chúc mừng, sự kết hợp thật hoàn hảo! Sau khi đổ hỗn hợp vào khuôn nướng bánh, giờ là lúc cho hỗn hợp vào lò nướng kỹ thuật số trong khoảng 3 giây. Khoảng thời gian đó là đủ để có lớp nền xốp đẹp.');
...
$( ".oven" ).droppable({
  drop: function( event, ui ) {
      $('.stage3').fadeOut();
      fire_modal('https://s3-us-west-2.amazonaws.com/s.cdpn.io/217233/oven_modal.png','Bake successfull!','Đúng! Ánh Ly là một đầu bếp bậc thầy. Phần đế đã được nướng hoàn toàn và trông siêu ngon. Bây giờ là lúc kết hợp lớp nền này với nhiều nguyên liệu khác như mứt, mứt cam, sô cô la, v.v.');
  }
})
